public class TestDriver {
    public static void main(String[] args) {
        ...
        System.out.println(mine.toString() + " ?= [y, o, u, r, ssss, null, null, null, null, null]\n");
        //PART 3 testing #1,6
        ...
        int count = 0;
        for (int idx = 0; idx < ligma.toString().length() - 3; idx++) {
            if (ligma.toString().substring(idx, idx + 4).equals("null")) {
                count++;
            }
        }
